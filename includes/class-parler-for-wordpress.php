...
class Parler_For_Wordpress
{
    ...
    {
        if (defined('Parler_For_WordpressVERSION')) {
            $this->version = Parler_For_WordpressVERSION;
        } else {
            $this->version = '1.0.0';
        }
     ...
     *
     * - Parler_For_WordpressLoader. Orchestrates the hooks of the plugin.
     * - Parler_For_Wordpressi18n. Defines internationalization functionality.
     * - Parler_For_WordpressAdmin. Defines all hooks for the admin area.
     * - Parler_For_WordpressPublic. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies()
    {
        ...
        $this->loader = new Parler_For_WordpressLoader();
     ...
     *
     * Uses the Parler_For_Wordpressi18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function set_locale()
    {
        ...
        $plugin_i18n = new Parler_For_Wordpressi18n();
    ...
    {
        $plugin_public = new Parler_For_WordpressPublic($this->get_plugin_name(), $this->get_version());
     ...
     *
     * @since     1.0.0
     * @return    Parler_For_WordpressLoader    Orchestrates the hooks of the plugin.
     */
