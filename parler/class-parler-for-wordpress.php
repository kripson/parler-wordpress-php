...
class Parler_For_WordPress {
	...
	public function __construct() {
		...
		// Ping bg jobs @todo this might be an ok spot for this but maybe there might be somewhere better.
		$parler_import_posts_process = new Parler_Import_Posts_Process();
	}
	 ...
	 *
	 * - Parler_For_WordPress_Loader. Orchestrates the hooks of the plugin.
	 * - Parler_For_WordPress_I18n. Defines internationalization functionality.
	 * - Parler_For_WordPress_Admin. Defines all hooks for the admin area.
	 * - Parler_For_WordPress_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Parler_For_WordPress_I18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		$plugin_admin = new Parler_For_WordPress_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_init', $plugin_admin, 'parley_register_settings_page' );
	...
	private function define_public_hooks() {
		$plugin_public = new Parler_For_WordPress_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Parler_For_WordPress_Loader    Orchestrates the hooks of the plugin.
	 */
